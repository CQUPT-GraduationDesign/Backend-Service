...
$this->params['sideBarConfig']['dataFetch']['items'][0]['items'][1]['isAc']  = true;
...
$this->registerJsFile("http://go.king-liu.net/datatable-js/datatables-fetched-trainin.js");
?>
<?php // render reused view ?>
<?php
    echo $this->render('_dataTable.php' , ['data' => $data]);
?>
