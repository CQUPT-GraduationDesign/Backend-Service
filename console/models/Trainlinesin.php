...
/**
 * This is the model class for table "trainlinesin".
 *
 * @property integer $id
 ...
 */
class Trainlinesin extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            ['fromtrain' , 'unique' , 'targetAttribute' => ['fromtrain' , 'totrain' , 'trainno' , 'starttime'] , 'message' => 'data is not unique [trainlines IN]'],
