...
/**
 * This is the model class for table "planelinein".
 *
 * @property integer $id
 ...
 */
class Planelinein extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            ['fromname' , 'unique' , 'targetAttribute' => ['fromname' , 'toname' , 'planeno' , 'starttime'] , 'message' => 'data is not unique [planelines IN]'],
            [['cityid'], 'integer'],
            [['rawdata'], 'string'],
